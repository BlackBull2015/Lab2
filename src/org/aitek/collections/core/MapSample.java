...
public class MapSample extends CollectionSample implements PropertyChangeListener {
	...
	private WeakHashMap<Integer, Integer> hashtable;
	private ConcurrentHashMap<Integer, Integer> hashMap;
	private IdentityHashMap<Integer, Integer> linkedHashMap;
	private ConcurrentSkipListMap<Integer, Integer> treeMap;
	private Task task;
	...
	public MapSample(StatsPanel statsPanel, Main main) {
		...
		hashtable = new WeakHashMap<Integer, Integer>();
		hashMap = new ConcurrentHashMap<Integer, Integer>();
		linkedHashMap = new IdentityHashMap<Integer, Integer>();
		treeMap = new ConcurrentSkipListMap<Integer, Integer>();
	}
