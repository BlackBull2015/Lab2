...
public class Main extends JFrame implements ActionListener, ChangeListener {
	...
	public Main() throws Exception {
		...
		StatsPanel listPanel = new StatsPanel("List", new String[] { "ArrayList", "RoleList", "Stack" });
		...
		StatsPanel mapPanel = new StatsPanel("Map", new String[] { "WeakHashMap", "ConcurrentHashMap", "IdentityHashMap", "ConcurrentSkipListMap" });
